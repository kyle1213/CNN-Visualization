...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(), "D:/User_Data/Desktop/github/CNN Visualization/CIFAR-100/model/" + str(0) + ".pth")
    ...
    for epoch in range(1, 1001):
        ...
        if epoch == 10 or epoch == 100 or epoch == 500 or epoch == 1000:
            torch.save(model.state_dict(), "D:/User_Data/Desktop/github/CNN Visualization/CIFAR-100/model/" + str(epoch) + ".pth")
